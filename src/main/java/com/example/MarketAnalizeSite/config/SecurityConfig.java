package com.example.MarketAnalizeSite.config;

import com.example.MarketAnalizeSite.service.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/", "/registration","/products","/product/*", "/resources/**",
                                "/css/**", "/js/**", "/images/**")
                        .permitAll()
